# Bismillah
"""
Created on Mon Jul  8 17:26:32 2024
...
# def display(word):
#     print(f"Men {len(word)} xonali so'z oyladim uni topa olasizmi?\n {'-'*(len(word))}")

#     while True:
#         savol = input("Harf kiriting\n>>>")
#         if savol == word:
#             break
#         if savol in word:
#             "-" == savol
#             print('Bu harf to\'g\'ri, qoganlarini kiriting:')
#         else:
#             print("Bu harf noto'g'ri!")
